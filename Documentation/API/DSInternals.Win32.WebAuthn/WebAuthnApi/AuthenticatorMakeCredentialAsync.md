# WebAuthnApi.AuthenticatorMakeCredentialAsync method (1 of 2)
...
```csharp
public Task<AuthenticatorAttestationResponse> AuthenticatorMakeCredentialAsync(
...
# WebAuthnApi.AuthenticatorMakeCredentialAsync method (2 of 2)
