...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = @'
- Implemented a workaround for PublicKeyCredentialCreationOptions generated by Microsoft with corrupted BASE64 padding.
- Added support for running under a service principal identity.
...
Note that the API is currently in public preview (beta).
'@
