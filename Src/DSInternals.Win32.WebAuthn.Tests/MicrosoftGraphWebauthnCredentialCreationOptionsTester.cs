...
{
    [TestClass]
    public class MicrosoftGraphWebauthnCredentialCreationOptionsTester
    {
        [TestMethod]
        public void MicrosoftGraphWebauthnCredentialCreationOptions_Deserialize()
        {
            var options = MicrosoftGraphWebauthnCredentialCreationOptions.Create(@"{
               ""@odata.context"":""https://graph.microsoft.com/beta/$metadata#microsoft.graph.webauthnCredentialCreationOptions"",
                ""challengeTimeoutDateTime"":""2024-06-13T11:26:35Z"",
                ""publicKey"":{
                    ""rp"": {
            ...
            Assert.AreEqual("login.microsoft.com", options.PublicKeyOptions.RelyingParty.Id);
        }
    }
}
