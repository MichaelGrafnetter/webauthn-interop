...
namespace DSInternals.Win32.WebAuthn.ADStore
{
    ...
    public class KeyCredential
    {
        ...
        /// </summary>
        private FidoKeyMaterial _cachedFidoKeyMaterial;
        ...
        public FidoKeyMaterial FidoKeyMaterial
        {
            get
            {
                if (this.Usage == KeyUsage.FIDO && this._cachedFidoKeyMaterial == null && this.RawKeyMaterial != null)
                {
                    ...
                    this._cachedFidoKeyMaterial = JsonConvert.DeserializeObject<FidoKeyMaterial>(fidoCredString);
                }
