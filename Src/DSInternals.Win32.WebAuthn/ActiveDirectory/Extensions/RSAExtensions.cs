...
{
    // TODO: Remove RSAExtensions from DSInternals.Common
    public static class RSAExtensions
    {
        ...
        private static readonly BigInteger[] WeakKeyMarkers = {
            ...
            BigInteger.Parse("618970019642690137449562110", NumberFormatInfo.InvariantInfo),
        ...
        public static bool IsWeakKey(this RSAParameters publicKey)
        {
            ...
            BigInteger modulus = new BigInteger(publicKey.Modulus.Reverse().Concat(new[] { Byte.MinValue }).ToArray());
